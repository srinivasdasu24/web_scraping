...
print("Total no_of Jobs = ", job_no)
npo_jobs_df = pd.DataFrame.from_dict(npo_jobs,orient='index',columns=['Job title','Location','Date','Link','Job_attributes','Job_Description'])
npo_jobs_df.head()
